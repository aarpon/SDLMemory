...
int main(int argc, char **argv)
{
	...
	cout	<< "-------------------------------------------------------------------------------" << endl
		...
		<< "Aaron Ponti, April 17, 2004 - http://www.gpres.org (OS4 port by C.Holborn)                              " << endl
		<< "-------------------------------------------------------------------------------" << endl;
	int leave=0;
	int dispHelp=0;
	int dispVers=0;
	for (int n=1;n<argc;n++)
	{
		...
		if ((dispHelp==0) && ((strcmp(argv[n],"-h")==0) || (strcmp(argv[n],"--help")==0)))
		{
			cout	<< "SDLMemory can be run with following (optional) arguments:" << endl
				<< "-h or --help      : this help" << endl
				<< "-v or --version   : displays version information" << endl
		...
		{
			cout	<< "Release version   : 0.2b1" << endl
				<< "Release date      : April 17, 2004" << endl
				<< "Supported OSes    : Linux, Win32" << endl
				<< "License           : GPL (http://www.gnu.org/copyleft/gpl.html)" << endl
				<< "Author            : Aaron Ponti" << endl
				<< "Contact           : contact@gpres.org" << endl
